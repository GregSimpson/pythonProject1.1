...
class Auth0Model:
    ...
    def gjs1(self):
        ...
        print(" firing : get_auth0_mgmt_access_token")
        self.get_auth0_mgmt_access_token()  #  works it just takes a while
        #asyncio.ensure_future( self.get_auth0_mgmt_access_token() )  #  testing a different example
        print(" gjs1 AFTER get_auth0_mgmt_access_token - carrying on")



    def get_auth0_mgmt_access_token(self):
        print(" running method async get_auth0_mgmt_access_token")

        # management API access token
        conn = http.client.HTTPSConnection("ttec-ped-developers.auth0.com")
        payload = "{\"client_id\":\"<clientId Jm0... >\",\"client_secret\":\"<client secret 6C2>\",\"audience\":\"https://ttec-ped-developers.auth0.com/api/v2/\",\"scope\":\"read:roles\",\"grant_type\":\"client_credentials\"}"
        ...
        print (data)
        print(" FINISHED method async get_auth0_mgmt_access_token")
